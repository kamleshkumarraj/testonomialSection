...
function DesignSection() {
  ...
  return (
    <section id="design-section" className='w-full text-[#000000] 2xl:mt-[100px] xl:mt-[80px] lg:mt-[70px] md:mt-[60px] sm:mt-[55px] mt-[50px] 2xl:px-[80px] xl:p-[40px] p-[20px]'>
        <header id="heading">
            <h1 id="main-heading" className='font-[poppins] 2xl:text-[56.24px] xl:text-[52px] lg:text-[48px] sm:text-[43px] text-[40px] leading-[50px] font-[500] 2xl:leading-[84.36px] tracking-[2.96] text-center' >Choose what you need designedr</h1>
